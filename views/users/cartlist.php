...
<head>
    ...
    <title><?php echo $sitename ?> - User CartList Page</title>
   ...
   <style>
    ...
    #bt-p{
        height: 100%;
        box-shadow: 0px 0px 1px 1px blueviolet;
        border-radius: 5px;
    }
   </style>
<body>
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        $select = mysqli_query($conection, "SELECT c.card_id,i.id,i.name,i.des,i.image,i.amount,i.sold FROM items i, cart c WHERE c.card_id=i.id AND user_id='$userLogin'");
